...
export const FACTION_MAGIC_PROFILES: Record<CanonicalFactionKey, FactionMagicProfile> = {
  ...
  Foresta: {
    ...
    doctrine: 'Control absoluto del tempo de disparo a distancia, enlentecimiento masivo del rival y blindaje de primera línea con Ents ancestrales.',
    manaEconomyStrategy: 'Conexión con arboledas sagradas que recargan maná tras victorias; rotación constante de Lentitud y Bendición para maximizar proyectiles.',
    preferredMasterfulSpells: [
      'Lentitud Masiva Magistral (Permite 2-3 rondas de disparo libre a distancia máxima)',
      'Piel de Granito Masiva (+8 Defensa y -15% daño plano en Treants)',
      'Aceleración Masiva (Unicornios y Dragones Esmeralda cargan en Turno 1)',
  ...
  Cisma: {
    ...
    doctrine: 'Distorsión de la realidad espaciotemporal, teleportación táctica de constructos pesados, duplicación ilusoria y purga implacable de mejoras.',
    manaEconomyStrategy: 'Generadores de Foco y Alquimia Arcana; ciclos constantes de recarga de habilidades activas con Energizar.',
    preferredMasterfulSpells: [
      'Salto Dimensional Bélico (Gólems y Constructos asaltan retaguardia con ataque gratis)',
      'Celeridad Temporal Magistral (Todo el ejército actúa en primer lugar con +50% iniciativa)',
      'Reflejo Espejo Perfecto (Réplicas ilusorias inmunes a disipación con 100% de ataque)',
...
export const FACTION_SPELL_COMBOS: Record<CanonicalFactionKey, FactionSpellCombo[]> = {
  ...
  Foresta: [
    {
      id: 'sylvan-combo-1',
      title: 'Combo 1: Batería de Arquería Esmeralda',
      subtitle: 'Lentitud Masiva y Bendición Divina para Doble Disparo Letal a Rango Máximo',
      ...
      beneficiaryUnits: ['Cazadores Silvanos', 'Tiradores Maestros', 'Dríadas', 'Druidas Arcanos'],
      recommendedHeroes: ['Elleshar', 'Gelu de Jadame', 'Ivoris', 'Sylvia'],
      executionSteps: [
        'Turno 1: Lanza Lentitud Masiva N4; inmoviliza a todo el ejército enemigo reduciendo su velocidad en -4 casillas.',
        'Turno 2: Lanza Bendición Divina N4; cada flecha de los Cazadores Silvanos impacta en su valor máximo con +15% daño sagrado.',
        'Gracias al doble disparo de los Elfos y al rango total sin penalización de distancia, el ejército enemigo es diezmado antes de recorrer 2 casillas.',
      ],
      competitiveAdvantage: 'Permite limpiar bancos de criaturas y monstruos de alto tier en los Días 1 al 14 con cero contacto cuerpo a cuerpo.',
    },
    {
      id: 'sylvan-combo-2',
      title: 'Combo 2: Muralla Viva de Treants Ancestrales',
      subtitle: 'Piel de Granito Masiva y Aguas Vivificantes en Cuellos de Botella',
      school: 'Primigenia & Luz',
      iconType: 'shield',
      timing: 'Semana 2-3 (Mid Game)',
      keySpells: [
      ...
      beneficiaryUnits: ['Treants Ancestrales (Hombres Árbol)', 'Unicornios de Guerra', 'Dríadas'],
      recommendedHeroes: ['Fael', 'Elleshar', 'Taelar'],
      executionSteps: [
        'Posiciona a los Treants Ancestrales en el centro del tablero o en el puente de asedio para enraizar a las tropas rivales.',
        'Lanza Piel de Diamante N4 (+8 Defensa y 15% de reducción de daño físico plano a todo el ejército).',
        'Cuando los Treants reciban múltiples asaltos concentrados, lanza Sanación Oleada N4 restaurando 180 + 30×Poder PV a todo el ejército vivo.',
        'Los Treants actúan como una esponja impenetrable mientras los arqueros disparan por encima con impunidad.',
      ],
      competitiveAdvantage: 'Crea una muralla viva prácticamente indestructible que anula cualquier intento de avance de caballería enemiga.',
    },
    {
      id: 'sylvan-combo-3',
      title: 'Combo 3: Vórtice Silvano Relámpago',
      subtitle: 'Aceleración Masiva de Unicornios Cegadores y Dragones Esmeralda',
      ...
      beneficiaryUnits: ['Unicornios de Guerra', 'Dragones Esmeralda', 'Fénix Silvanos'],
      recommendedHeroes: ['Elleshar', 'Aeris'],
      executionSteps: [
        'Turno 1: Aceleración Masiva N4 (+4 Velocidad y +20% Iniciativa).',
        'Los Dragones Esmeralda y Unicornios impactan en el Turno 1 contra los hechiceros o tiradores rivales, aplicando Ceguera Pasiva al golpear.',
        'Turno 2: Lanza Implosión N4 (950 + 230×Poder PV) para borrar de un solo golpe al comandante o criatura de Tier 7 restante del enemigo.',
      ],
      competitiveAdvantage: 'Combina el asalto físico ultrarrápido con el mayor daño explosivo mono-objetivo del juego.',
    },
  ],
  Colmena: [
    {
  ...
  Cisma: [
    {
      id: 'schism-combo-1',
      title: 'Combo 1: Salto de Constructo Bélico',
      subtitle: 'Teletransporte Magistral de Gólems Pesados con Ataque Inmediato',
      ...
      beneficiaryUnits: ['Gólems de Cisma', 'Colosos de Alquimia', 'Constructos de Guerra'],
      recommendedHeroes: ['Vann', 'Khorad', 'Cynthia', 'Brann'],
      executionSteps: [
        'Turno 1: Lanza Celeridad Temporal N4; todo tu ejército de constructos recibe +50% de iniciativa y +2 Velocidad.',
        'Lanza Teletransporte Magistral N4 enviando a tu Gólem de Alquimia más pesado directamente al centro de la línea enemiga.',
        'El Gólem ejecuta su ataque de demolición de forma gratuita e inmediata con +20% de daño base.',
        'El enemigo gasta su contraataque en el Gólem de alta armadura, dejando a sus tropas vulnerables a tus tiradores de distorsión.',
      ],
      competitiveAdvantage: 'Resuelve la mayor debilidad de Cisma (la baja velocidad de los Gólems) convirtiéndolos en asesinos de Turno 1.',
    },
    {
      id: 'schism-combo-2',
      title: 'Combo 2: Bombardeo Arcano & Sobrecarga de Foco',
      subtitle: 'Rayo en Cadena y Recarga Instantánea de Habilidades con Energizar',
      school: 'Arcana (Arcane)',
      iconType: 'sparkles',
      timing: 'Late Game (Batalla Final)',
      keySpells: [
      ...
      beneficiaryUnits: ['Artificieros Arcanos', 'Constructos de Rayo', 'Colosos de Cisma'],
      recommendedHeroes: ['Vann', 'Astra', 'Valen'],
      executionSteps: [
        'Turno 1: Descarga Tempestad en Cadena N4 golpeando a hasta 7 escuadras enemigas con un daño colosal de 450 + 105×Poder.',
        'Turno 2: Lanza Energizar Magistral N4; resetea instantáneamente los tiempos de recarga de todas las habilidades activas de tus unidades y añade +30% daño.',
        'Tus Artificieros y Constructos disparan sus rayos especiales por segunda vez consecutiva, limpiando el campo.',
      ],
      competitiveAdvantage: 'Descarga dos rondas de habilidades de máxima potencia en un solo turno, colapsando cualquier ejército enemigo.',
    },
    {
      id: 'schism-combo-3',
      title: 'Combo 3: Réplica Espejo & Purga de Vacío',
      subtitle: 'Duplicación Inmune a Disipación y Despojo Total de Magia Enemiga',
      ...
      beneficiaryUnits: ['Colosos de Guerra', 'Artificieros', 'Gólems de Cisma'],
      recommendedHeroes: ['Vann', 'Cynthia'],
      executionSteps: [
        'Lanza Réplicas Espejo Supremas N4 sobre tu escuadra más poderosa (crea 2 copias con 100% de ataque que resisten 3 golpes y son inmunes a disipación).',
        'Si el enemigo intenta lanzar mejoras o bendiciones para igualar la potencia, usa Disipación Universal Masiva por 6 Maná.',
        'Tus copias destruyen las unidades clave del rival mientras tu ejército real permanece a salvo.',
      ],
      competitiveAdvantage: 'Triplica la presencia en mesa de tus unidades más caras a una fracción de su coste en oro y recursos.',
    },
  ],
};
...
export const FACTION_SPELL_PRIORITIES: Record<CanonicalFactionKey, Record<string, SpellFactionPriority>> = {
  ...
  Foresta: {
    'spell-slow': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Imprescindible para Cazadores Silvanos. Permite 2 o 3 ráfagas completas de flechas a distancia máxima sin peligro.',
      keyUnitsBenefited: ['Cazadores Silvanos', 'Tiradores Maestros', 'Dríadas'],
    },
    'spell-blessing': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Garantiza el daño máximo de los arqueros y añade daño sagrado a cada disparo.',
      keyUnitsBenefited: ['Cazadores Silvanos', 'Druidas'],
    },
    'spell-thick-hide': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Convierte a los Treants Ancestrales en una muralla impenetrable con +8 de Defensa y -15% daño físico plano.',
      keyUnitsBenefited: ['Treants Ancestrales', 'Unicornios'],
    },
    'spell-quicksand': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Bloquea los caminos hacia los arqueros silvanos; los Treants son inmunes en Nivel 4.',
      keyUnitsBenefited: ['Cazadores Silvanos', 'Treants'],
    },
    'spell-fire-wall': {
      priority: 'Alta (P3)',
      synergyTip: 'Protege las esquinas donde se agrupan los arqueros de Foresta.',
    },
    'spell-haste': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Permite a Unicornios y Dragones Esmeralda cruzar el campo en Turno 1 y cegar hechiceros enemigos.',
      keyUnitsBenefited: ['Unicornios de Guerra', 'Dragones Esmeralda'],
    },
    'spell-cure': {
      priority: 'Alta (P3)',
      synergyTip: 'Mantiene sanos a los Ents y purga venenos de todo el ejército vivo en combates largos.',
      keyUnitsBenefited: ['Treants', 'Unicornios'],
    },
    'spell-meteor-shower': {
      priority: 'Alta (P3)',
      synergyTip: 'Castiga a ejércitos compactos que intenten refugiarse detrás de cuellos de botella.',
      keyUnitsBenefited: ['Héroes Druidas'],
    },
    'spell-implosion': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Permite a los Druidas eliminar amenazas colosales que resistan los disparos de flechas.',
    },
    'spell-town-portal': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Fundamental para defender arboledas sagradas y reunir arqueros de todo el reino élfico.',
    },
    'spell-dimension-door': {
      priority: 'Imprescindible (P1)',
    ...
    'spell-dispel': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Limpia ralentizaciones enemigas sobre tus Unicornios y Cazadores.',
    },
  },
  Colmena: {
    'spell-haste': {
  ...
  Cisma: {
    'spell-arcane-bolt': {
      ...
      keyUnitsBenefited: ['Héroes Alquimistas', 'Vann'],
    },
    'spell-teleport': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Compensa la lentitud de los Gólems de Cisma soltándolos en la retaguardia enemiga con ataque gratis.',
      keyUnitsBenefited: ['Gólems de Cisma', 'Constructos de Guerra', 'Colosos'],
    },
    'spell-early-start': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Adelanta el turno de todo el ejército de constructos un +50% en la barra de iniciativa.',
      keyUnitsBenefited: ['Todo el ejército de Cisma'],
    },
    'spell-time-warp': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Permite que Gólems y Colosos de Cisma ataquen dos veces consecutivas en el mismo turno.',
      keyUnitsBenefited: ['Colosos de Guerra', 'Gólems de Cisma'],
    },
    'spell-mana-drain': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Drena el maná del héroe rival antes de que lance sus grandes conjuros y da lanzamiento gratis a tu héroe.',
      keyUnitsBenefited: ['Héroes Alquimistas'],
    },
    'spell-dispel': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Disipación Universal Masiva a 6 Maná limpia todos tus constructos y arrebata mejoras al rival.',
      keyUnitsBenefited: ['Todo el ejército'],
    },
    'spell-energize': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Resetea instantáneamente las recargas de habilidades activas de Artificieros y Constructos con +30% daño.',
      keyUnitsBenefited: ['Artificieros Arcanos', 'Constructos'],
    },
    'spell-optical-illusion': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Duplica Gólems y Constructos de alto tier con réplicas inmunes a disipación que absorben 3 impactos.',
      keyUnitsBenefited: ['Gólems de Cisma', 'Colosos'],
    },
    'spell-chain-lightning': {
      priority: 'Muy Alta (P2)',
      synergyTip: 'Descarga un rayo en cadena sobre 7 objetivos enemigos con daño masivo sin degradación.',
      keyUnitsBenefited: ['Héroes Magos de Cisma'],
    },
    'spell-town-portal': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Conexión entre talleres de alquimia y forjas arcanas en todo el territorio de Jadame.',
    },
    'spell-dimension-door': {
      priority: 'Imprescindible (P1)',
      synergyTip: 'Teletransporte dimensional masivo para saltar fortificaciones rivales.',
    },
    'spell-dusk-dampening': {
      priority: 'Alta (P3)',
      synergyTip: 'Protege a los constructos frente a magia elemental enemiga y absorbe maná.',
    },
  },
};
