...
export const FACTION_THEMES_LIGHT: Record<FactionId, FactionTheme> = {
  Mazmorra: {
    ...
    tabActive: 'bg-purple-700 text-white shadow-[0_4px_16px_rgba(147,51,234,0.40)] border border-purple-600 font-bold',
  ...
  Templo: {
    ...
    tabActive: 'bg-amber-600 text-slate-950 shadow-[0_4px_16px_rgba(217,119,6,0.40)] border border-amber-500 font-bold',
  ...
  Necrópolis: {
    ...
    tabActive: 'bg-slate-800 text-white shadow-[0_4px_16px_rgba(71,85,105,0.40)] border border-slate-700 font-bold',
  ...
  Cisma: {
    ...
    tabActive: 'bg-sky-700 text-white shadow-[0_4px_16px_rgba(2,132,199,0.40)] border border-sky-600 font-bold',
