...
export const OFFICIAL_SUBCLASSES: SubclassInfo[] = [
  ...
  // -----------------------------------------------------------------------
  // ARBOLEDA (GROVE / GUARDIANES & ELFOS SILVANOS)
  // -----------------------------------------------------------------------
  {
  ...
  // -----------------------------------------------------------------------
  {
    ...
    recommendedHeroes: ['Baluarte', 'Onkos'],
    tacticalTier: 'Tier S',
  ...
  },
  {
    ...
    recommendedHeroes: ['Rey de reyes', 'Baluarte'],
    tacticalTier: 'Tier S+',
  ...
  },
  {
    ...
    recommendedHeroes: ['Laura', 'Artorius Veritas'],
    tacticalTier: 'Tier S+',
  ...
  },
  {
    ...
    recommendedHeroes: ['Funerella', 'Lord Rufus'],
    tacticalTier: 'Tier S',
  ...
  // -----------------------------------------------------------------------
  // ENJAMBRE (HIVE / INSECTOIDES & CAUDILLOS)
  // -----------------------------------------------------------------------
  {
    ...
    nameEn: 'Broodmother',
    faction: 'Enjambre',
    baseClass: 'Caudillo del Enjambre (Warlord)',
    classType: 'Guerrero',
  ...
  },
  {
    ...
    bonusEffect: 'Los ataques de las unidades del Enjambre ignoran el 100% de la defensa enemiga cuando la unidad enemiga tiene menos del 50% de su salud.',
    requiredSkills: [
      { name: 'Exploración', nameEn: 'Scouting', tier: 'Experta' },
      { name: 'Hechicería', nameEn: 'Sorcery', tier: 'Experta' },
      { name: 'Magia primigenia', nameEn: 'Primal Magic', tier: 'Experta' },
  ...
  },
  {
    ...
    nameEn: 'Progenitor',
    faction: 'Enjambre',
    baseClass: 'Chamán del Enjambre (Shaman)',
    classType: 'Mago',
