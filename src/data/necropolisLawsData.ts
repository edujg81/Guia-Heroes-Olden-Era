...
export const NECROPOLIS_LAW_PRESETS: FactionLawPreset[] = [
  {
    ...
    description: 'Enfoque diseñado para maximizar la recolección de Mineral y Mercurio y erigir el Palacio de los Vampiros de Shadowspire en el Día 14.',
    totalCost: 50,
    steps: [
    ...
    ranks: [
      {
        ...
        tacticalImpact: 'Garantiza que la vanguardia vampírica sea completamente imparable y limpie el campo sin recibir réplicas.',
