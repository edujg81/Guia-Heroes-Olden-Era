...
// Mapeo de IDs en español (de los archivos de datos) a entradas del catálogo
// Esto permite que getHeroPortrait('hero-aguijon') encuentre hero-stinger
const SPANISH_ID_MAP: Record<string, string> = {
  'hero-aguijon': 'hero-stinger',
  'hero-viejo-lord-mandall': 'hero-old-lord-mandall',
  'hero-keandra': 'hero-leandra',
  'hero-el-hereje-avis': 'hero-heretic-avis',
  'hero-anastasia-la-mansa': 'hero-anastasia-the-meek',
  'hero-lia-desatada': 'hero-lia-the-untethered',
  'hero-gorel-punta-de-lanza': 'hero-gorel-spearhead',
  'hero-colajengibre': 'hero-gingertail',
  'hero-viejo-peregrino': 'hero-old-peregrinator',
  'hero-seductora-sha': 'hero-alluring-sha',
  'hero-tia-daliar': 'hero-aunt-daliar',
  'hero-anciano-tsskish': 'hero-elder-tsskish',
  'hero-aeliniel': 'hero-capreola',
  'hero-echolily': 'hero-echolalia',
  'hero-suli': 'hero-sullie',
  'hero-el-juglar': 'hero-mute-minstrel',
  'hero-tarius': 'hero-iratus',
  'hero-kel-ghul': 'hero-kelghul',
  'hero-maestro-klastor': 'hero-klasto',
  'hero-milossa-la-dorada': 'hero-milossa-the-golden',
  'hero-goldentongue-enjambre': 'hero-goldentongue',
  'hero-lo-enjambre': 'hero-x-lo',
  'hero-pauper-enjambre': 'hero-pauper-x-wistari',
  'hero-zixx-enjambre': 'hero-xtaviola',
  'hero-khariseth-enjambre': 'hero-abigor-enjambre',
  'hero-mila-enjambre': 'hero-x-mila',
  'hero-groo-enjambre': 'hero-grooo',
  'hero-bathym-enjambre': 'hero-bathin-duke-of-jewels',
  'hero-oriax-enjambre': 'hero-oriax',
  'hero-fleu-enjambre': 'hero-fleu',
  'hero-leira-enjambre': 'hero-x-ramman',
  'hero-tavi-enjambre': 'hero-x-aleria',
  'hero-xirr-enjambre': 'hero-hera-hera',
};

Object.entries(SPANISH_ID_MAP).forEach(([esId, enId]) => {
  const entry = HERO_NORM_MAP.get(enId.toLowerCase());
  if (entry) {
    HERO_NORM_MAP.set(esId.toLowerCase(), entry);
  }
});
...
export function getHeroPortrait(nameOrId: string, faction?: string): string | undefined {
  ...
  // 3. Fallback: buscar en modulos importados
