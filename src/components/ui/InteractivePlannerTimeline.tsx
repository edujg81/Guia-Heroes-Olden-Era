...
export const InteractivePlannerTimeline: React.FC<InteractivePlannerTimelineProps> = ({
  ...
  const phases = [
    ...
    },
    {
      ...
      range: 'Días 8-14 (S2)',
      desc: 'Fortificaciones II, Fortificaciones III y Rush a Tier 6/7',
      days: [8, 14],
      icon: Swords,
      color: 'red',
    },
    {
      id: 3,
      name: 'Fase 3: Expansión & Metrópolis III',
  ...
  const milestones = [
    ...
    { day: 14, label: 'D14: Rush T7', icon: '⚡', tip: 'Tier 7 / Fortificaciones III edificado' },
