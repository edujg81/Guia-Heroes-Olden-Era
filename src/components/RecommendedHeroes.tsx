...
const FACTION_CLASS_NAMES: Record<FactionId, { guerrero: string; mago: string }> = {
  ...
  Colmena: { guerrero: 'Ejecutor', mago: 'Canalizador' },
...
const FACTION_HERO_HIGHLIGHTS: Record<FactionId, {
  ...
  Necrópolis: {
    ...
    magicDesc: 'Ethric catapulta la velocidad, salud y crecimiento de los Liches. Mag domina la Magia Arcana con +1 nivel y uso sin límites. Artorius Veritas asegura maná inagotable con Hechicería.',
    physTitle: 'Recomendación Meta: Físicos',
    physNames: 'Rey de reyes, Zam & Baluarte (Golpe Heroico & Falange)',
    physDesc: 'Rey de reyes reduce la moral enemiga con Golpes Heroicos letales. Zam potencia el combate y genera mercurio diario. Baluarte otorga gran defensa y resistencia física.',
    econTitle: 'Economía & Soporte Logístico',
    econNames: 'Lord Rufus (Economía del Sepulcro) & Zam (Alquimia del Mercurio)',
