...
const FACTION_HERO_HIGHLIGHTS: Record<FactionId, {
  ...
  Necrópolis: {
    magicTitle: 'Recomendación Meta: Mágicos',
    magicNames: 'Artorius Veritas & Funerella (Hechicería & Saber Fúnebre)',
    magicDesc: 'Artorius Veritas optimiza el consumo de maná y lanza hechizos oscuros continuos. Funerella escala de nivel a velocidad vertiginosa con Percepción y Sabiduría.',
    physTitle: 'Recomendación Meta: Físicos',
    physNames: 'Rey de reyes & Baluarte (Golpe Heroico & Bastión Óseo)',
    physDesc: 'Rey de reyes reduce la moral enemiga y asesta Golpes Heroicos letales. Baluarte otorga gran defensa y resistencia física a la infantería no-muerta.',
    econTitle: 'Economía & Soporte Logístico',
    econNames: 'Lord Rufus (Economía del Sepulcro) & Laura (Bruja de la Noche)',
    econDesc: 'Lord Rufus genera oro diario adicional y abarata edificaciones de ciudad. Laura combina nigromancia temprana con magia de batalla.',
  },
  Enjambre: {
    magicTitle: 'Recomendación Meta: Mágicos',
    magicNames: 'Zixx & Xilith (Mente Suprema & Avispas Neurotóxicas)',
    magicDesc: 'Zixx otorga +1 Velocidad y +2 Ataque en Turno 1 y potencia los biohechizos primordiales. Xilith aplica veneno paralizante y drena movimiento en mapa al rival.',
    physTitle: 'Recomendación Meta: Físicos',
    physNames: 'Niev, Zoran & Curson (Asalto de Mantis & Waurms)',
    physDesc: 'Niev salta murallas con Mantis Voraces para aniquilar tiradores. Zoran convierte a los Waurms en arietes con barrido cónico. Curson encadena turnos extra por eliminación.',
    econTitle: 'Economía & Soporte Logístico',
    econNames: 'Skith (Horda de Larvas) & Verrid (Incubador de Nidos)',
    econDesc: 'Skith lidera con triple pila de larvas y Ataque de Manada para limpiar el mapa el Día 1. Verrid genera capullos y crecimiento masivo semanal.',
  },
  Cisma: {
    magicTitle: 'Recomendación Meta: Mágicos',
    magicNames: 'Hermana Keiri, Dhüvri & Tölketh (Nochesombra & Dilatación)',
    magicDesc: 'Hermana Keiri ciega y aniquila con Magia de Nochesombra. Dhüvri maximiza la Comunión Abisal. Tölketh manipula el espacio y recupera maná tras cada conjuro.',
    physTitle: 'Recomendación Meta: Físicos',
    physNames: 'Nihil, Matastala & El Doncel de Hierro (Anti-Magia & Vanguardia)',
    physDesc: 'Nihil suprime la magia enemiga y drena reservas de maná. Matastala lidera Jinetes de Aga\'shoth devastadores. El Doncel de Hierro encadena y controla enemigos pesados.',
    econTitle: 'Economía & Soporte Logístico',
    econNames: 'Mártir Tho (Alquimista & Recursos) & Ulkuth (Exploración Dimensional)',
    econDesc: 'Mártir Tho transmuta materiales raros y abarata mejoras arcanas. Ulkuth abre niebla de guerra y maximiza puntos de movimiento diarios.',
  },
};
